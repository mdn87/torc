...
Status: implementation complete; P1a gate pending external verification
...
- Run deterministic replay separately on macOS and compare payload bytes and
  canonical score-core bytes and hashes.
